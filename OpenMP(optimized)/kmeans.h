...
public:
    ...
    void initializeCentroids(std::vector<Centroid>& centroids, const std::vector<Point>& points);
    void assignPointsToClusters(std::vector<Point>& points, const std::vector<Centroid>& centroids);
